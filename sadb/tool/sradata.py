...
def import_gene_info(inputfile):
    ...
    with open(inputfile) as reader:
        ...
        for line in reader:
            ...
            record["Tissue"]=sagd_info["Tissue"]
            record["Stage"] = sagd_info["Stage"]
            ...
            if record["padj"]!="NA" and record["padj"]<0.05:
                if record["log2FoldChange"]!="NA" and (record["log2FoldChange"]>2 or record["log2FoldChange"]<-2):
